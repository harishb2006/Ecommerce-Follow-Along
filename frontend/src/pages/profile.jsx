				...
				<div className="w-full h-full bg-neutral-700 rounded-lg">
					...
					<div className="w-full h-max my-2 p-5">
						...
						<div className="w-full h-max p-5">
							<button className="w-max px-3 py-2 bg-neutral-600 text-neutral-100 rounded-md text-center hover:bg-neutral-100 hover:text-black transition-all duration-100" onClick={handlAddAddress}>
								Add Address
							</button>
						</div>
